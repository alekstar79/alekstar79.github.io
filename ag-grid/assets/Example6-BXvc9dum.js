import{A as G,E as _,C as $}from"./main.esm-DqBob0QU.js";import{d as y,i as V,o as g,c as A,a as s,b as u,u as D,F as B,r as v,g as k,s as p,_ as T,e as z,w}from"./index-CwHQ-y8K.js";const F=y({__name:"Example6.demo",emits:["log"],setup(x,{emit:r}){const o=r,l=V("onGridReady"),n=v([...[{id:1,firstName:"Иван",salary:1e5},{id:2,firstName:"Мария",salary:15e4},{id:3,firstName:"Алексей",salary:2e5}]]);let c=4;const C=k(()=>[{id:"total",firstName:"ИТОГО",salary:n.value.reduce((a,d)=>a+d.salary,0)}]),h=p([{field:"id",headerName:"ID",width:80,editable:!1},{field:"firstName",headerName:"Имя",editable:!0},{field:"salary",headerName:"Зарплата",editable:!0,cellEditor:"agNumberCellEditor",valueFormatter:e=>e.value?`${e.value.toLocaleString("ru-RU")} ₽`:""}]),E=p({sortable:!0,resizable:!0,filter:!0});let t=null;function I(e){t=e.api,e.api.sizeColumnsToFit(),l&&l()}function N(e){const a=e.column.getColId(),d=e.data.id,i=n.value.findIndex(m=>m.id===d);if(i!==-1){const f={...n.value[i],[a]:e.newValue};n.value=[...n.value.slice(0,i),f,...n.value.slice(i+1)],t==null||t.applyTransaction({update:[f]})}o("log",`Изменено поле "${a}": "${e.oldValue}" → "${e.newValue}"`)}function b(){if(!t)return;const e={id:c++,firstName:`Новый ${c-1}`,salary:Math.round(Math.random()*1e5+5e4)};n.value=[...n.value,e],t.applyTransaction({add:[e]}),o("log",`Добавлен сотрудник: ${e.firstName} с зарплатой ${e.salary}`)}return(e,a)=>(g(),A(B,null,[s("div",{class:"controls"},[s("button",{onClick:b},"➕ Добавить сотрудника"),a[0]||(a[0]=s("span",{style:{"margin-left":"12px","font-size":"0.9rem",color:"#475569"}}," 💡 Редактируйте имя или зарплату – итог пересчитается автоматически ",-1))]),u(D(G),{style:{flex:"1",width:"100%"},rowData:n.value,columnDefs:h.value,defaultColDef:E.value,pinnedBottomRowData:C.value,animateRows:!0,onGridReady:I,onCellValueChanged:N},null,8,["rowData","columnDefs","defaultColDef","pinnedBottomRowData"])],64))}}),H=T(F,[["__scopeId","data-v-3f19796c"]]),L=`<template>
  <div class="controls">
