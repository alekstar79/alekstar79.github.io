import{C as D}from"./ConsoleOutput-q6McdQfj.js";import{A as R,E as _}from"./main.esm-ZSTnD18R.js";import{d as m,i as k,o as f,b as A,e as l,a as i,u as p,F as G,r as g,s as d,_ as E,c as V,w as u}from"./index-Bc4Mc_9k.js";const $=m({__name:"Example5.demo",emits:["log"],setup(h,{emit:a}){const t=a,o=k("onGridReady"),r=g([{id:1,firstName:"Иван",lastName:"Петров",status:"active"},{id:2,firstName:"Мария",lastName:"Сидорова",status:"fired"},{id:3,firstName:"Алексей",lastName:"Козлов",status:"active"},{id:4,firstName:"Елена",lastName:"Иванова",status:"active"}]),C=d([{headerName:"",width:50,checkboxSelection:!0,headerCheckboxSelection:!0,headerCheckboxSelectionFilteredOnly:!0,suppressSizeToFit:!0},{field:"id",headerName:"ID",width:80},{field:"firstName",headerName:"Имя"},{field:"lastName",headerName:"Фамилия"},{field:"status",headerName:"Статус"}]),N=d({sortable:!0,resizable:!0,filter:!0});let e=null;function w(n){e=n.api,n.api.sizeColumnsToFit(),o&&o()}function S(){e==null||e.selectAll(),t("log","Выбраны все строки")}function b(){e==null||e.deselectAll(),t("log","Выделение снято")}function v(){const n=(e==null?void 0:e.getSelectedRows())??[];if(n.length===0)t("log","Ни одна строка не выбрана");else{const s=n.map(c=>`${c.firstName} ${c.lastName}`).join(", ");t("log",`Выбраны строки: ${s}`)}}function x(n){const s=n.api.getSelectedRows().length;t("log",`Выделение изменено: выбрано ${s} строк(а)`)}function y(){e==null||e.exportDataAsCsv({fileName:"employees.csv",allColumns:!0,onlySelected:!1}),t("log","Экспорт CSV выполнен (все строки)")}return(n,s)=>(f(),A(G,null,[l("div",{class:"controls"},[l("button",{onClick:S},"Выбрать все"),l("button",{onClick:b},"Снять выделение"),l("button",{onClick:y},"Экспорт CSV"),l("button",{onClick:v},"Показать выбранные")]),i(p(R),{style:{flex:"1",width:"100%"},rowData:r.value,columnDefs:C.value,defaultColDef:N.value,rowSelection:"multiple",animateRows:!0,onGridReady:w,onSelectionChanged:x},null,8,["rowData","columnDefs","defaultColDef"])],64))}}),F=E($,[["__scopeId","data-v-cb616647"]]),z=`<template>
  <div class="controls">
...
`,j="Selection и экспорт",T="Демонстрация множественного выбора строк, работы с выделением и экспорта данных в CSV.",O=m({__name:"Example5",setup(h){const a=g([]);function t(o){a.value.push(`[${new Date().toLocaleTimeString()}] ${o}`)}return(o,r)=>(f(),V(_,{title:j,description:T,code:p(z),language:"html",onLog:t},{console:u(()=>[i(D,{logs:a.value},null,8,["logs"])]),default:u(()=>[i(F,{onLog:t})]),_:1},8,["code"]))}});export{O as default};
