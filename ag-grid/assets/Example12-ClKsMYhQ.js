...
`,V="Pagination",B="Пагинация в Community: переключение страниц, выбор размера, события pagination-changed.",L=C({__name:"Example12",setup(G){const l=b([]);function t(a){l.value.push(`[${new Date().toLocaleTimeString()}] ${a}`)}return(a,m)=>(D(),N(S,{title:V,description:B,code:r(O),language:"html",onLog:t},{console:P(()=>[f(T,{logs:l.value},null,8,["logs"])]),default:P(()=>[f(I,{onLog:t})]),_:1},8,["code"]))}});export{L as default};
