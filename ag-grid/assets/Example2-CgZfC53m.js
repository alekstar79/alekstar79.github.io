import{C as x}from"./ConsoleOutput-q6McdQfj.js";import{A as R,E as G}from"./main.esm-ZSTnD18R.js";import{d as p,i as k,o as g,b as I,e as r,a as i,u as y,F as $,r as h,s as m,_ as E,c as A,w as f}from"./index-Bc4Mc_9k.js";const F=p({__name:"Example2.demo",emits:["log"],setup(C,{emit:l}){const n=l,o=k("onGridReady"),d=h([{id:1,firstName:"Иван",lastName:"Петров",age:32,salary:22e4,status:"active",hired:"2021-03-01"},{id:2,firstName:"Мария",lastName:"Сидорова",age:27,salary:18e4,status:"fired",hired:"2022-07-15"},{id:3,firstName:"Алексей",lastName:"Козлов",age:41,salary:25e4,status:"active",hired:"2019-11-20"},{id:4,firstName:"Елена",lastName:"Иванова",age:35,salary:2e5,status:"active",hired:"2020-05-10"}]),u=(t,a)=>(t??"").localeCompare(a??"","ru",{sensitivity:"base"}),c=(t,a)=>(t??1/0)-(a??1/0),N=m([{field:"id",headerName:"ID",width:80},{field:"firstName",headerName:"Имя",comparator:u},{field:"lastName",headerName:"Фамилия",comparator:u},{field:"age",headerName:"Возраст",comparator:c},{field:"salary",headerName:"Зарплата",comparator:c,valueFormatter:t=>t.value?`${t.value.toLocaleString("ru-RU")} ₽`:""},{field:"status",headerName:"Статус"},{field:"hired",headerName:"Дата приема"}]),b=m({sortable:!0,resizable:!0,filter:!0});let e=null;function S(t){e=t.api,t.api.sizeColumnsToFit(),o&&o()}function v(){e==null||e.applyColumnState({state:[{colId:"salary",sort:"desc"}],defaultState:{sort:null}}),n("log","Сортировка по зарплате ↓")}function D(){e==null||e.applyColumnState({state:[{colId:"salary",sort:"asc"}],defaultState:{sort:null}}),n("log","Сортировка по зарплате ↑")}function _(){e==null||e.applyColumnState({defaultState:{sort:null}}),n("log","Сортировка сброшена")}function w(){const a=((e==null?void 0:e.getColumnState())??[]).filter(s=>s.sort);n("log",a.length?`Текущая сортировка: ${a.map(s=>`${s.colId}: ${s.sort}`).join(", ")}`:"Сортировка не активна")}return(t,a)=>(g(),I($,null,[r("div",{class:"controls"},[r("button",{onClick:v},"Сортировать по зарплате ↓"),r("button",{onClick:D},"Сортировать по зарплате ↑"),r("button",{onClick:_},"Сбросить сортировку"),r("button",{onClick:w},"Показать текущую сортировку")]),i(y(R),{style:{flex:"1",width:"100%"},rowData:d.value,columnDefs:N.value,defaultColDef:b.value,animateRows:!0,onGridReady:S},null,8,["rowData","columnDefs","defaultColDef"])],64))}}),j=E(F,[["__scopeId","data-v-c78979c5"]]),V=`<template>
  <div class="controls">
...
`,z="Сортировка и comparator",B="Демонстрация стандартной сортировки, кастомных comparator-ов и программного управления сортировкой через GridApi.",U=p({__name:"Example2",setup(C){const l=h([]);function n(o){l.value.push(`[${new Date().toLocaleTimeString()}] ${o}`)}return(o,d)=>(g(),A(G,{title:z,description:B,code:y(V),language:"html",onLog:n},{console:f(()=>[i(x,{logs:l.value},null,8,["logs"])]),default:f(()=>[i(j,{onLog:n})]),_:1},8,["code"]))}});export{U as default};
