import{C as G}from"./ConsoleOutput-q6McdQfj.js";import{A as _,E as $}from"./main.esm-ZSTnD18R.js";import{d as y,i as V,o as g,b as A,e as s,a as u,u as D,F as B,r as v,g as k,s as p,_ as T,c as z,w}from"./index-Bc4Mc_9k.js";const F=y({__name:"Example6.demo",emits:["log"],setup(x,{emit:r}){const o=r,l=V("onGridReady"),n=v([...[{id:1,firstName:"Иван",salary:1e5},{id:2,firstName:"Мария",salary:15e4},{id:3,firstName:"Алексей",salary:2e5}]]);let c=4;const C=k(()=>[{id:"total",firstName:"ИТОГО",salary:n.value.reduce((a,d)=>a+d.salary,0)}]),h=p([{field:"id",headerName:"ID",width:80,editable:!1},{field:"firstName",headerName:"Имя",editable:!0},{field:"salary",headerName:"Зарплата",editable:!0,cellEditor:"agNumberCellEditor",valueFormatter:e=>e.value?`${e.value.toLocaleString("ru-RU")} ₽`:""}]),E=p({sortable:!0,resizable:!0,filter:!0});let t=null;function I(e){t=e.api,e.api.sizeColumnsToFit(),l&&l()}function N(e){const a=e.column.getColId(),d=e.data.id,i=n.value.findIndex(m=>m.id===d);if(i!==-1){const f={...n.value[i],[a]:e.newValue};n.value=[...n.value.slice(0,i),f,...n.value.slice(i+1)],t==null||t.applyTransaction({update:[f]})}o("log",`Изменено поле "${a}": "${e.oldValue}" → "${e.newValue}"`)}function b(){if(!t)return;const e={id:c++,firstName:`Новый ${c-1}`,salary:Math.round(Math.random()*1e5+5e4)};n.value=[...n.value,e],t.applyTransaction({add:[e]}),o("log",`Добавлен сотрудник: ${e.firstName} с зарплатой ${e.salary}`)}return(e,a)=>(g(),A(B,null,[s("div",{class:"controls"},[s("button",{onClick:b},"➕ Добавить сотрудника"),a[0]||(a[0]=s("span",{style:{"margin-left":"12px","font-size":"0.9rem",color:"#475569"}}," 💡 Редактируйте имя или зарплату – итог пересчитается автоматически ",-1))]),u(D(_),{style:{flex:"1",width:"100%"},rowData:n.value,columnDefs:h.value,defaultColDef:E.value,pinnedBottomRowData:C.value,animateRows:!0,onGridReady:I,onCellValueChanged:N},null,8,["rowData","columnDefs","defaultColDef","pinnedBottomRowData"])],64))}}),H=T(F,[["__scopeId","data-v-4970ffd8"]]),L=`<template>
  <div class="controls">
...
`,M="Закреплённых строки (pinned rows)",j="Закреплённая снизу строка автоматически показывает сумму зарплат. При редактировании данных (имя, зарплата) или добавлении нового сотрудника итог пересчитывается. Полезно для отчётов и сводных таблиц.",P=y({__name:"Example6",setup(x){const r=v([]);function o(l){r.value.push(`[${new Date().toLocaleTimeString()}] ${l}`)}return(l,R)=>(g(),z($,{title:M,description:j,code:D(L),language:"html",onLog:o},{console:w(()=>[u(G,{logs:r.value},null,8,["logs"])]),default:w(()=>[u(H,{onLog:o})]),_:1},8,["code"]))}});export{P as default};
